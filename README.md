...
UFRN-ML-2025-1-Iracing_Classification/
│
├── .ipynb_checkpoints/           # Auto-generated by Jupyter for notebook recovery.
├── images/                       # Stores output images like graphs and confusion matrices.
├── models/                       # Saves the trained model weights (e.g., .pth files).
├── test_dataset_iracing/         # Labeled image data for the test/validation set.
├── train_dataset_iracing/        # Labeled image data for the training set.
│
├── EDA.ipynb                     # Notebook for Exploratory Data Analysis.
├── Iracing_classification.ipynb  # Main notebook for training and running the iRacing model.
├── README.md                     # This documentation file.
├── convolucoes.xlsx              # Spreadsheet for calculating covolutions ouputs
├── printscreen_generator.ipynb   # Notebook used to automatically capture gameplay screenshots.
├── requirements.txt              # Lists the project's Python dependencies for easy setup.
└── test_labeling.py              # Python script, for the manual classification tool.
```
---
# ❓ Problem Description
